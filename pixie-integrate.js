 ...
 *
 *
 * This file code is meant for Advanced Editor
 *
 *
 */
...
(function (window, undefined) {
  ...
  Pixie = function () {
    ...
    instance = {
      save: function (format, quality) {
        _pixie.save(format, quality);
        return this;
      },
      getService: function (name) {
        return _pixie.getService(name);
      },
      ...
      enableInteractiveMode: function (options) {
        _pixie.enableInteractiveMode(options);
        return this;
      },
      getParams: function () {
        return _pixie.params;
      },
      setOptions: function (options) {
        _pixie.setOptions(options);
        return this;
      },
    };
  ...
  _pixie = {
    ...
    create: function (callback) {
      ...
      link.rel = "stylesheet";
      link.href = this.getPath() + "advancedEditorAssests/css/integrate.css";
