// Chat Markup
function chatTaskMarkup(messageItem, nextMessageWasSentByMe, index, trackerId) {
  const { sender_id, message_id, message, type } = messageItem;

  const markup = `
              <div class="chat_message_item_container_first_wrapper chatMessageContainer--${index}" id="${USERID === sender_id ? "sendMessageCategory" : "receiverMessageCategory"}" data-message-id="${message_id}">
                    ...
                    <div class="chat_message_item_container ${USERID === sender_id ? "sender_message" : "receiver_message"}">
                      ...
                      <div class="chat_message">
                        <div class="message_content">
                          <div class="messgae_task_container">
                            <div class="desc">You created a task with John</div>
                            <div class="project_info">
                              <span class="task_status task_status--pending"></span>
                              <span>
                                <img src="./images/chat/icons/document.svg">
                              </span>
 ...
 *
 */
// Chat recorded Audio Markup
function chatRecordedMarkup(messageItem, nextMessageWasSentByMe, index, trackerId) {
  const { sender_id, message_id, audioURL } = messageItem;

  const sender = sender_id === USERID;
  const svgColor = sender ? "#FFFFFF" : "#33363F";

  const markup = `
              <div class="chat_message_item_container_first_wrapper chatMessageContainer--${index}" id="${sender ? "sendMessageCategory" : "receiverMessageCategory"}" data-message-id="${message_id}">
                <div class="chat_message_item_container_second_wrapper ${nextMessageWasSentByMe ? "" : "space_down"}">
                  <div data-message-id="${message_id}" class="message_in">
                    <div class="chat_message_quick_action chat-hidden">
                      <div class="chat_message_item_options_wrapper">
                    ...
                    <div class="chat_message_item_container ${sender ? "sender_message" : "receiver_message"}">
                      ${sender ? `<svg width="16" height="16" fill="#8837e9" style="position: absolute; z-index: -1; top: -6px; right: 0px; transition-property: scale, fill; transition-duration: 300ms; transition-timing-function: cubic-bezier(0.31, 0.1, 0.08, 0.96); transition-delay: 0ms; will-change: fill;"><path d="M-2.70729e-07 6.19355C8 6.19355 12 4.12903 16 6.99382e-07C16 6.70968 16 13.5 10 16L-2.70729e-07 6.19355Z"></path></svg>` : `<svg width="16" height="16" fill="#ffffff" style="position: absolute; z-index: 1; top: -6px; left: 0px; transition-property: scale, fill; transition-duration: 300ms; transition-timing-function: cubic-bezier(0.31, 0.1, 0.08, 0.96); transition-delay: 0ms; will-change: fill;" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M16 6.19355 C8 6.19355 4 4.12903 0 6.99382e-07 C0 6.70968 0 13.5 6 16 L16 6.19355 Z"/></svg>`}
                      <div class="chat_emoji_container animate__animated animate__pulse ${HIDDEN}">
                        <button class="chat_emoji_container--button" data-emoji="😀">😀</button>
                        <button class="chat_emoji_container--button" data-emoji="🔥">🔥</button>
                        <button class="chat_emoji_container--button" data-emoji="❤️">❤️</button>
                      ...
                      <div class="chat_message">
                        <div class="recorded_message_content">
                          <div class="recorded_message_content_container">
                            <button disabled data-mode="idle" id="playAudioButton--${message_id}" aria-label="Play Audio">
                              <svg class="play" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="${svgColor}" d="M18.54 9L8.88 3.46a3.42 3.42 0 0 0-5.13 3v11.12A3.42 3.42 0 0 0 7.17 21a3.43 3.43 0 0 0 1.71-.46L18.54 15a3.42 3.42 0 0 0 0-5.92Zm-1 4.19l-9.66 5.62a1.44 1.44 0 0 1-1.42 0a1.42 1.42 0 0 1-.71-1.23V6.42a1.42 1.42 0 0 1 .71-1.23A1.5 1.5 0 0 1 7.17 5a1.54 1.54 0 0 1 .71.19l9.66 5.58a1.42 1.42 0 0 1 0 2.46Z"/></svg>
                              <svg class="pause" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="${svgColor}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 7c0-1.414 0-2.121.44-2.56C4.878 4 5.585 4 7 4s2.121 0 2.56.44C10 4.878 10 5.585 10 7v10c0 1.414 0 2.121-.44 2.56C9.122 20 8.415 20 7 20s-2.121 0-2.56-.44C4 19.122 4 18.415 4 17zm10 0c0-1.414 0-2.121.44-2.56C14.878 4 15.585 4 17 4s2.121 0 2.56.44C20 4.878 20 5.585 20 7v10c0 1.414 0 2.121-.44 2.56c-.439.44-1.146.44-2.56.44s-2.121 0-2.56-.44C14 19.122 14 18.415 14 17z" color="${svgColor}"/></svg>
                            </button>

                            <div class="message_waveform" data-audio-path="${audioURL}" id="waveform--${message_id}"></div>

                            <div id="waveform_time">45:00</div>
                          </div>
...
function typingMarkup(msg, nextMessageWasSentByMe, i, type = "") {
  const { sender_id } = msg;
  return `
    <div class="typing_markup_wrapper">
      <div class="typing_markup ${USERID === sender_id ? "sender_message" : "receiver_message"} ${nextMessageWasSentByMe ? "" : "space_down"}">
        <div class="profile_wrapper ${type !== "group" ? "" : "group"}">
        ${
          type !== "group"
            ? `<img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fHByb2ZpbGV8ZW58MHx8MHx8fDA%3D" alt="" />`
            : `
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fHByb2ZpbGV8ZW58MHx8MHx8fDA%3D" alt="" />
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fHByb2ZpbGV8ZW58MHx8MHx8fDA%3D" alt="" />
             `
        ...
        <div class="bubble">
          ...
          <ul class="animation-dropdown-up">
            <li role="button" data-status="waiting">Waiting</li>
            <li role="button" data-status="hold on">Hold on</li>
            <li role="button" data-status="continue">Continue</li>
            <li role="button" data-status="stop">Stop</li>
          </ul>
        </div>
      </div>
    </div>
...
// Chat Live Coin Markup
function liveCoinMarkup(messageItem, nextMessageWasSentByMe, trackerId, i) {
  const { senderId, messageId, message, type, liveChatGameInfo } = messageItem;

  const iconsToShow = liveChatGameInfo?.type === "coin" ? `<img src="./images/chat/icons/in-chat-coin.svg"/>` : liveChatGameInfo?.type === "boost" && liveChatGameInfo?.amount < 500 ? `<img src="./images/chat/icons/in-chat-boost.svg"/>` : `<img src="./images/chat/icons/in-chat-booster.svg"/>`;
  const textToShow = liveChatGameInfo?.type === "coin" ? `Coins ${liveChatGameInfo.count > 1 ? `🔥 X${liveChatGameInfo.count}` : ""}` : liveChatGameInfo?.type === "boost" && liveChatGameInfo?.amount < 500 ? "Booster" : `Top Booster ${liveChatGameInfo.count > 1 ? `🔥 X${liveChatGameInfo.count}` : ""}`;
                  ...
                  <div data-message-id="${messageId}" class="message_in">
                   ...
                   ${
                    ...
                    <div class="chat_message_item_container ${USERID === senderId.id ? "sender_message" : "receiver_message"}">
                      ...
                      <div class="chat_message">
                        <div class="message_content game_message">
                          ${
                            liveChatGameInfo?.type
                              ? `
                                <div class="chat_message_content">
                                  <div style="display: flex; align-items: center;">
                                    <span>You &bull;</span>  
                                    ${iconsToShow}
                                    <span style="color: #37B6F2">${textToShow}</span>
                                  </div>
                                  <p style="color: #FF3B30; font-size:11px">Just dropped ${liveChatGameInfo.amount} coins <span>💸</span></p>
...
// Chat Map Markup
function chatMapMarkup(messageItem, nextMessageWasSentByMe, trackerId, i) {
  const { sender_id, message_id, message, type, location_address, coords } = messageItem;
          ...
          <div class="chat_message_item_container ${USERID === sender_id ? "sender_message" : "receiver_message"}">
            ...
            <div class="chat_message">
              <div class="message_content">
                ...
                <div class="chat_message_image images-1">
                  <div class="top-box">
                    <a href="https://www.google.com/maps/search/${location_address}/@${lat},${lng},17z?hl=en" target="_blank" rel="noopener noreferrer">
                      <img src="${messageItem.thumbnail}" alt="" />
                    </a>
                  </div>
                </div>
                 ...
                 <div class="chat_message_content">
                    <div class="chat_message_content--text">
                      <span>
                        <div class="location_message--info">
                          <div>
                            <img src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D" alt="" />
                          </div>    
                          <div>
...
//
function chatDocumentMarkup(messageItem, nextMessageWasSentByMe, trackerId, i) {
  const { type, sender_id, message_id, document, reactions } = messageItem;
  ...
  return `  <div class="chat_message_item_container_first_wrapper chatMessageContainer--${i}" id="${USERID === sender_id ? "sendMessageCategory" : "receiverMessageCategory"}" data-message-id="${message_id}">
                <div class="chat_message_item_container_second_wrapper ${nextMessageWasSentByMe ? "" : "space_down"}">
                  <div data-message-id="${message_id}" class="message_in">
                    <div class="chat_message_quick_action chat-hidden">
                      <div class="chat_message_item_options_wrapper">
                      ...
                      <div class="chat_message">
                        <div class="message_content">
                           ${
                             type === "document"
                               ? `
                                <div class="chat_message_file chatOnDocument" tabindex="0" data-doc-type="${document.type}">
                                  <div>
