function renderCollaboratorsShared(collaborationArray, container) {
  container.innerHTML = "";
  ...
  collaborationArray.forEach((collaborate, index) => {
                    ...
                    <div class="item_overflow_wrapper">
                      <div class="tab_overflow_item">
                        <div class="right_hand">
                          <div class="user_info">
                            <div class="profile_image" id="profile_image_shared--btn--${index}">
                              <div style="position: relative; height: 100%">
                                <img src="${collaborate.profile_image}" alt="${collaborate.name}" title="${collaborate.description}" />
                                <span class="online_sign"></span>
                              </div>

                              <div class="profile_details_container collaboration-hidden" aria-hidden="true" id="profile_image_shared--${index}">
                        ...
                        <div class="left_hand">
                          <div class="left_hand_wrapper">
                            ...
                            <button class="share_collab--btn collab_invite">
    ...
    const buttonEl = document.getElementById(`profile_image_shared--btn--${index}`);
    const dropdownEl = document.getElementById(`profile_image_shared--${index}`);
