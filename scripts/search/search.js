...
filter_menu.forEach((el, key) => {
  // console.log(el.contains(`li`));
  // el.setAttribute(`x-on:click`, `$refs.selected_menu.innerText=$el.innerHTML`);
  // el.addEventListener(`click`, function () {
  //     if(key == 0 ) filter_menu_seleted.setAttribute(`data-filter_select`, `false`);
  //     filter_menu_seleted.setAttribute(`data-filter_select`, `true`);
  // })
});
