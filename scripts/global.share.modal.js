...
const showFollowingShareModalBtns = document.querySelectorAll(".show-following-share-modal-btn");
const followingShareModal = document.getElementById("followingShareMdal");
const followingShareModalManualCancel = document.getElementById("followingShareModalManualCancel");
...
followingShareModalManualCancel.addEventListener("click", hideGlobalShareFollowingModal);
...
const followingShareClipboardBtn = document.getElementById("followingShareClipboardBtn");

followingShareClipboardBtn.addEventListener("click", function () {
  const URLText = this.closest(".clipboard").querySelector(".text-to-copy").textContent;
